...
def predict_fraud(request: FraudRequest, source: str = "live", request_id: str = None) -> dict:
    ...
    log_prediction(request_dict, response, MODEL_RUN_ID, source=source, request_id=request_id)
